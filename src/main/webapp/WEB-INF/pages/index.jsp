            ...
            $("#loginbtn").click(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data!=null && data!=""){
                            if (data.result.trim()=="wrong"){
                                $("#error-text").text("账号不存在或密码错误!");
                            }
                            else if(data.result.trim()=="banned") {
                                $("#error-text").text("没有权限,请联系管理员!");
                            }
                            else if (data.result.trim()=="success"){
                                $("#error-text").text("登陆成功，正在为您跳转到成员注册页面");
...
<div id="test">
    ...
    <div id="head-title">
        <span class="glyphicon glyphicon-user"> Java兴趣社团成员管理平台</span>
    </div>
    ...
    <form role="form-horizontal">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="id" placeholder="请输入管理员账号" required>
